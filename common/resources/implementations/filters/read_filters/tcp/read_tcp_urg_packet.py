...
class ReadTCPUrgPacketFilter:
    ...
    Attributes:
        ...
        filter_expression (str): The BPF (Berkeley Packet Filter) expression used to read TCP URG packets.
    """
    description: str = "Filter to read TCP URG packets"
